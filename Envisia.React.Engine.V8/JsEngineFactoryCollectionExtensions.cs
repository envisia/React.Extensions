...
public static class JsEngineFactoryCollectionExtensions
{
    ...
    public static JsEngineFactoryCollection AddEnvisiaV8(this JsEngineFactoryCollection source)
    {
        if (source == null)
        {
        ...
        return source.AddEnvisiaV8(new V8Settings());
    }
    ...
    /// <returns>Instance of <see cref="JsEngineFactoryCollection" /></returns>
    public static JsEngineFactoryCollection AddEnvisiaV8(
        this JsEngineFactoryCollection source, 
        Action<V8Settings> configure)
    {
        ...
        return source.AddEnvisiaV8(settings);
    }
    ...
    /// <returns>Instance of <see cref="JsEngineFactoryCollection" /></returns>
    public static JsEngineFactoryCollection AddEnvisiaV8(this JsEngineFactoryCollection source, V8Settings settings)
    {
        if (source == null)
        {
            throw new ArgumentNullException(nameof(source));
