...
public abstract class EnvisiaReactSharedTagHelper(IReactEnvironment reactEnvironment) : TagHelper
{
    protected readonly IReactEnvironment ReactEnvironment = reactEnvironment;
